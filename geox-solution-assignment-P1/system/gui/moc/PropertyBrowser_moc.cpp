...
struct qt_meta_stringdata_PropertyBrowserWidget_t {
    QByteArrayData data[4];
    char stringdata[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PropertyBrowserWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PropertyBrowserWidget_t qt_meta_stringdata_PropertyBrowserWidget = {
    {
QT_MOC_LITERAL(0, 0, 21), // "PropertyBrowserWidget"
QT_MOC_LITERAL(1, 22, 11), // "sigModified"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 11) // "sltModified"

    },
    "PropertyBrowserWidget\0sigModified\0\0"
    "sltModified"
};
...
void PropertyBrowserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PropertyBrowserWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PropertyBrowserWidget::sigModified)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PropertyBrowserWidget::staticMetaObject = {
    { &QScrollArea::staticMetaObject, qt_meta_stringdata_PropertyBrowserWidget.data,
      qt_meta_data_PropertyBrowserWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PropertyBrowserWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PropertyBrowserWidget.stringdata))
