...
struct qt_meta_stringdata_ClassTypeClassPropertyEditorWidget_t {
    QByteArrayData data[5];
    char stringdata[71];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClassTypeClassPropertyEditorWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClassTypeClassPropertyEditorWidget_t qt_meta_stringdata_ClassTypeClassPropertyEditorWidget = {
    {
QT_MOC_LITERAL(0, 0, 34), // "ClassTypeClassPropertyEditorW..."
QT_MOC_LITERAL(1, 35, 11), // "sigModified"
QT_MOC_LITERAL(2, 47, 0), // ""
QT_MOC_LITERAL(3, 48, 16), // "selectionChanged"
QT_MOC_LITERAL(4, 65, 5) // "index"

    },
    "ClassTypeClassPropertyEditorWidget\0"
    "sigModified\0\0selectionChanged\0index"
};
...
void ClassTypeClassPropertyEditorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ClassTypeClassPropertyEditorWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClassTypeClassPropertyEditorWidget::sigModified)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ClassTypeClassPropertyEditorWidget::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_ClassTypeClassPropertyEditorWidget.data,
      qt_meta_data_ClassTypeClassPropertyEditorWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ClassTypeClassPropertyEditorWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClassTypeClassPropertyEditorWidget.stringdata))
