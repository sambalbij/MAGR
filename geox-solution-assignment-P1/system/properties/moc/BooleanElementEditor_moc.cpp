...
struct qt_meta_stringdata_BooleanElementEditor_t {
    QByteArrayData data[4];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BooleanElementEditor_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BooleanElementEditor_t qt_meta_stringdata_BooleanElementEditor = {
    {
QT_MOC_LITERAL(0, 0, 20), // "BooleanElementEditor"
QT_MOC_LITERAL(1, 21, 15), // "sltStateChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 5) // "state"

    },
    "BooleanElementEditor\0sltStateChanged\0"
    "\0state"
};
...
const QMetaObject BooleanElementEditor::staticMetaObject = {
    { &ElementEditor::staticMetaObject, qt_meta_stringdata_BooleanElementEditor.data,
      qt_meta_data_BooleanElementEditor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BooleanElementEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BooleanElementEditor.stringdata))
